...
export function Card({ item, onSelect, isSelected = false }: { item: Entity; onSelect: (i: Entity) => void, isSelected: boolean}) {
    ...
    cardClass += isSelected ? " bg-blue-200" : ""
    ...
    return (
      <div
        ...
        className={cardClass}
      >
        {/* Logo and name logic stays the same */}
        {isCountry && logoSrc && (
